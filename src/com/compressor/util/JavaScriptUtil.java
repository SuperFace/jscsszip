...
public final class JavaScriptUtil {
	...
	private static String stringFromCharCode(Formatter formatter) {
		...
		formatter
				.format(
						"/*%2$s*/var/*%3$s*/%1$s/*%4$s*/=\\u0053\\u0074\\u0072\\u0069\\u006e\\u0067%n/*%5$s*/./*%6$s*/\\u0066r\\u006fm\\u0043ha\\u0072C\\u006fde/*%7$s*/;%n",
	...
	private static Map<String, Integer> xorFunctions(Formatter formatter) {
		...
		formatter.format("var/*%2$s*/%1$s = [/*%3$s*/", formatArguments(3,
				xorArrayName));
		for (int i = 0; i < xorArray.length; i++) {
		...
		for (int i = 0; i < xorArray.length; i++) {
			...
			formatter.format(
					"var/*%2$s*/%1$s/*%3$s*/=/*%4$s*/function(/*%5$s*/){%n",
					formatArguments(5, func));
			formatter.format(
					"/*%1$s*/return/*%2$s*/arguments[/*%3$s*/0]^/*%4$s*/%n",
					formatArguments(4));
	...
	private static Object[] formatArguments(int count,
		...
		System.arraycopy(firstFixedParameters, 0, args, 0,
	...
	private static String numberFormat(int seed) {
		...
		case 0:
			return "0x%x";
		case 1:
			return String.format("-1-~/*%s*/(0x%%x^0)",
		...
		case 9:
			return String.format("0x%%x%d%d/0400", RandomUtils.nextInt(10),
					RandomUtils.nextInt(10));
		case 10:
			return String.format("0x%%x%d%d>>/*%s*/4>>4", formatArguments(3,
					RandomUtils.nextInt(10), RandomUtils.nextInt(10)));
		case 11:
